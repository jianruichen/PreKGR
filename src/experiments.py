...
# from src.wd_inference_parse_args import parser
# from src.wd_inference_parse_args import args
...
def inference(lf):
    ...
    if args.compute_map:
        ...
        test_metrics = src.eval.hits_and_ranks(test_data, pred_scores, search_traces, lf.kg, verbose=True , where="test", lf=lf)
        # eval_metrics['dev']['hits_at_1'] = dev_metrics["hit1"]
        # eval_metrics['dev']['hits_at_3'] = dev_metrics["hit3"]
        # eval_metrics['dev']['hits_at_5'] = dev_metrics["hit5"]
        # eval_metrics['dev']['hits_at_10'] = dev_metrics["hit10"]
